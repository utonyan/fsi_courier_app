...
class DeliveredFailed extends StatefulWidget {
  final Delivery delivery;
  const DeliveredFailed({super.key, required this.delivery});

  @override
  State<DeliveredFailed> createState() => _DeliveredFailedState();
}

class _DeliveredFailedState extends State<DeliveredFailed> {
  // Controllers
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              "Enter the necessary details to process the failed delivery.",
            ...
            StyledDropDown(
              ...
              onChanged: (value) => setState(() => _selectedAttempt = value),
            ),
